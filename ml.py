...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pickFileButton.setGeometry(QtCore.QRect(90, 210, 101, 41))
        font = QtGui.QFont()
        ...
        self.pickIndent.setGeometry(QtCore.QRect(250, 80, 180, 31))
        font = QtGui.QFont()
        ...
        self.enterIndent.setGeometry(QtCore.QRect(250, 110, 80, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(75)
        ...
        self.enterIndentLabel.setGeometry(QtCore.QRect(340, 110, 80, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(75)
        ...
        self.choiceTitle.setGeometry(QtCore.QRect(30, 110, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pickTitle.setGeometry(QtCore.QRect(30, 80, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.filePicked.setGeometry(QtCore.QRect(200, 210, 161, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pickFile.setGeometry(QtCore.QRect(90, 170, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.checkFile.setGeometry(QtCore.QRect(160, 280, 131, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.answer.setGeometry(QtCore.QRect(20, 350, 410, 250))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
